...
const timeline = [
  ...
  },
  {
    ...
    detail:
      "I had been really unhappy in my professional life for a long time, and eventually had enough. I had always had interest in technology, but had never considered that it could be for me. After trying a few free coding resources, I was hooked and I quit my job in order to pursue software development full time. During this time, I attended a bootcamp to provide some structure and acceleration to the learning process.",
    date: "Dec 2021",
    Icon: RocketIcon,
